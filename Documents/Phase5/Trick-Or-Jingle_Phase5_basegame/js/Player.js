...
export class Player extends Phaser.GameObjects.Sprite
{
    constructor(scene, _speed, _lives, x, y, _sprite, _idx) {
        ...
        this.arrow = scene.physics.add.staticSprite(1000,1000, 'weapons').setScale(1); // create out of frame because it has no weapon when created
    ...
    shootShotGun()
    {
        ...
        // create bullet
        var bullet = this.scene.physics.add.image(this.arrow.x, this.arrow.y, 'bulletshotgun').setImmovable(true); // Creates a bullet on the scene
        bullet.body.setAllowGravity(false);
